...
namespace IntelliTect.TestContainersDemo.Data;
...
public class DevelopmentAppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        builder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=IntelliTect.TestContainersDemo;Trusted_Connection=True;TrustServerCertificate=True;");
